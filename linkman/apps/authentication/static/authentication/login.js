document.addEventListener('DOMContentLoaded', () => {
    ...
    const verifiedModalContainer = document.getElementById("emailVerificationModal");
    ...
    const expiredModalContainer = document.getElementById("verificationExpiredModal");
    ...
    const closeResendEmailModal = document.getElementById("closeResendEmailModal");
